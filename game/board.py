...
class Board:
    ...
    def render_main_menu(self):
        ...
        print()
        print(f"    {green('[01]')} {gray('>')} human vs human")
        print(f"    {green('[02]')} {gray('>')} human vs random bot")
        print(f"    {green('[03]')} {gray('>')} human vs trained AI")
        print(f"    {green('[04]')} {gray('>')} spectate  {gray('::')} random bot vs AI")
        print(f"    {green('[05]')} {gray('>')} train the AI  {gray('(self-play)')}")
